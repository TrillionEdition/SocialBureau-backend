...
const sendMail = async ({ to, subject, html }) => {
  ...
  // 🛡️ MODE 2: Gmail (Fallback/Local)
    ...
    console.log("⏱️  [MAILER] No SendGrid key found. Falling back to Gmail Port 465...");
    transporter = nodemailer.createTransport({
      host: "smtp.gmail.com",
      port: 465,
      secure: true,
  ...
  try {
    ...
    throw new Error(`Email delivery failed: ${err.message}. If using Render, please provide a SENDGRID_API_KEY.`);
  }
};
