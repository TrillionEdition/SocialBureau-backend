...
//     console.log("ℹ️ Blog already sent, skipping");
//     return;
//   }
...
//   console.log(`📊 Newsletter delivery summary: ${successCount} sent, ${failureCount} failed`);

//   state.lastSentBlogId = blog._id;
//   await state.save();

//   console.log("✅ Blog + Job newsletter sent");
// };
